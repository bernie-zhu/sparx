...
## FINDING PATENTS LINK AND PUBLICATION NUMBER
...
headers = ['Company', 'Top 5 Targets', 'Top 5 Diseases']
targets = ['Targets', 'Top 10 Diseases', 'Number of Patents']
...
## DICTIONARY TO SQL DATABASE, CALL TO_SQL ON DIC, PARAMETERS AS TABLE HEADERS
