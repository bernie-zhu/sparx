    ...
    for aliases in alias_list:
        for cur in aliases:
            if len(str(cur)) >= 3:
                ...
                elif str(cur).lower() in descriptionStr and str(cur).lower() not in common_words:
                    lower = str(cur).lower()
                    countDescription = (
